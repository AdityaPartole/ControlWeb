...
const init = function () {
  ...
  <div class="popup-window-tab-contents tab-contents">  
    <section class="tab-content" id="popup-window-tab-content-1">
      <h3>General</h3>
      <p>ControlWeb is an open-source web app which lets Control Systems engineers design & experiment with LTI (linear time-invariant) dynamical systems online.</p>
      ...
      <h3>Motivation</h3>
      <p>The motivation behind ControlWeb is to create an open-source drafting table for studying control systems, which:</p>
      <ul>
      ...
      <h3>License</h3>
      <p>ControlWeb is licensed under the MIT license.</p>
    </section>
